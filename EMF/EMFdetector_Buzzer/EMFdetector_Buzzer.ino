...
void loop() {
  ...
  //int freq_sound = val*100;
  //int freq_sound = map(val, 0, 1023, 0, 25000); 
  int freq_sound = map(val, 0, val_max, 0, 25000); 
  //int freq_sound = pow(10,val/50)*1000;
  tone(buzzer_pin, freq_sound);
  //Serial.println(freq_sound);
