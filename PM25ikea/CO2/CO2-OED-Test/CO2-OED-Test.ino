...
#define RX_PIN 14                                          // D4 von WEMOS Mini Rx pin which the MHZ19 Tx pin is attached to
#define TX_PIN 12                                         // D3 von WEMOS Mini Tx pin which the MHZ19 Rx pin is attached to
#define BAUDRATE 9600                                      // Device to MH-Z19 Serial baudrate (should not be changed)
#define UPDATE_MS 1000                                      // Device to MH-Z19 Serial baudrate (should not be changed)
...
void setup()   {
  ...
  Serial.println("myMHZ19.autoCalibration");      
