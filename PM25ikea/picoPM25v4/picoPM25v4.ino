...
#define PINGINTERVAL		(900 * 1000)		// ms
...
void setup()
{
  ...
  pingInterval = PINGINTERVAL + millis(); // trigging the first reading
...
// void led_buitlin(unsigned int repeat, unsigned int delay_time) {
//   for (int i = 0; i < repeat; i++){
//     digitalWrite(LED_BUILTIN, HIGH);   // Arduino: turn the LED on (HIGH)
//     digitalWrite(D4, HIGH);   // Arduino: turn the LED on (HIGH)
//     Serial.print("blink-");
//     delay(delay_time);                       // wait
//   }
//   digitalWrite(LED_BUILTIN, LOW);    // Arduino: turn the LED off (LOW)
//   digitalWrite(D4, LOW);   // Arduino: turn the LED on (HIGH)
//   delay(delay_time);                       // wait
// }
