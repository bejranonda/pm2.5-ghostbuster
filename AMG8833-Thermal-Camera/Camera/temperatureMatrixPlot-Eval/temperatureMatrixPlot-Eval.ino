...
void loop() {
  ...
  const float min_thershold = 0.9;
  const float max_thershold = 1.1;
  const float negative_dif_thershold = 1.1;
  const float positive_dif_thershold = 1.1;
  ...
  while(true){
    ...
    float this_loop_max = -100;
    float this_loop_min = 100;
    float this_dif_postive_max = -100;
    float this_dif_negative_min = 100;
...
//          Serial.println(event_dif_negative_min);
    ...
    //      Serial.println("DnE");
      ...
      if(this_dif_postive_max > event_dif_positive_max){
        if(this_dif_postive_max > event_loop_max*positive_dif_thershold){
          if(this_dif_postive_max > event_loop_max*positive_dif_thershold*extreme_upper_thershold){
            loop_status = 8;  
          }else{
            loop_status = 4;  
          }
